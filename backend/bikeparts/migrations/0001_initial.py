    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headtube_types', models.ManyToManyField(related_name='stems', to='bikeproperties.HeadtubeType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pad_material', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='brake_pads', to='bikeproperties.Material')),
            ],
            options={
                'abstract': False,
            },
