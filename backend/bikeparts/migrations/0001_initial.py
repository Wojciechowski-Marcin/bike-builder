# Generated by Django 2.2.1 on 2019-10-13 16:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headtube_type', models.ManyToManyField(related_name='stems', to='bikeproperties.HeadtubeType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applications', models.ManyToManyField(related_name='shocks', to='bikeproperties.Application')),
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='shocks', to='bikeproperties.Brand')),
                ('color', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='shocks', to='bikeproperties.Color')),
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='shocks', to='bikeproperties.Group')),
                ('material', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='shocks', to='bikeproperties.Material')),
                ('shock_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='shocks', to='bikeproperties.ShockType')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('axle_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='frames', to='bikeproperties.AxleType')),
                ...
                ('brake_rotor_type', models.ManyToManyField(related_name='frames', to='bikeproperties.BrakeRotorType')),
                ...
                ('shock_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='frames', to='bikeproperties.ShockType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='brakes', to='bikeproperties.Material')),
            ],
            options={
                'abstract': False,
            },
